...
if("TRUE" STREQUAL "TRUE")
  set(nav_core_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/navigation/nav_core)
...
if(NOT "/home/ubuntu/catkin_ws/src/navigation/nav_core/include " STREQUAL " ")
  set(nav_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/navigation/nav_core/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/navigation/nav_core/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
